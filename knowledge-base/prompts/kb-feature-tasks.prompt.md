...
- If `plan.md` does not exist → stop. Phase 2 (Plan) must be completed first using `/kb-feature-plan`.
...
2. The next step is Phase 4 (Implementation) — they can use `/kb-feature-implement` when ready
