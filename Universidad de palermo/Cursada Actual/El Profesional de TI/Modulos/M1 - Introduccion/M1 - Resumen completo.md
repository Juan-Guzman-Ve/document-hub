...
```mermaid
flowchart LR
    U1["U1 · Introducción a la Gestión de TI<br/>(ESTAMOS ACÁ)"] --> U2["U2 · Gobierno corporativo<br/>y estándares relacionados"]
    U2 --> U3["U3 · Transformación digital"]
    U3 --> U4["U4 · Gestión de Infraestructura<br/>y Operaciones de TI"]
    U4 --> U5["U5 · Normas y estándares"]
    U5 --> U6["U6 · Gestión de Equipos y<br/>Recursos Humanos en TI"]
    U6 --> U7["U7 · Gestión de Contratos<br/>y Proveedores de TI"]
    U7 --> U8["U8 · Indicadores de Desempeño<br/>y Toma de Decisiones en TI"]
    U8 --> UF["★ El futuro del<br/>profesional de TI"]

    style U1 fill:#f7b733,stroke:#333,stroke-width:2px
```
...
timeline
    ...
    5 Ago 2026 : Inicio de cursada
    23 Sep 2026 : Parcial 1 (U1-U4)
    11 Nov 2026 : Parcial 2 (U5-U8)
    18 Nov 2026 : Recuperatorio / Fin de cursada
```
...
```mermaid
timeline
    title Evolución del profesional de TI
    1940s-1960s : Era mainframe : ENIAC (1945) : IBM 360 (1964)
    1960s-1970s : Centro de Procesamiento de Datos : COBOL y tarjetas perforadas : Nace el analista de sistemas
    1980s : Revolución de la PC : IBM PC / 5150 (1981) : Nace el soporte técnico / helpdesk
    1990s : Redes e Internet : LAN/WAN, cliente-servidor : Primeros ERP (SAP, PeopleSoft) : Nace el CIO
    2000s : Formalización y gobernanza : Se consolidan ITIL, COBIT, PMBOK : Nace el CISO
    2010s : Cloud, Agile y DevOps : AWS/Azure/GCP, de CapEx a OpEx : Nace el CDO
    2020s : IA y gobernanza algorítmica : IA generativa, low-code/no-code : Presión por ESG y ética algorítmica
```
...
```mermaid
flowchart LR
    A[Centralización] --> B[Descentralización] --> C[Redes] --> D[Nube] --> E[IA]
```
...
flowchart TD
    VUCA["Entorno VUCA"]
    VUCA --> V["V - Volátil<br/>El cambio es rápido<br/>e impredecible"]
    VUCA --> U["U - Incierto<br/>Falta claridad sobre<br/>eventos futuros"]
    VUCA --> C["C - Complejo<br/>Múltiples factores<br/>interconectados"]
    VUCA --> A["A - Ambiguo<br/>Las causas y efectos<br/>no son claros"]
```
